...
//         setUserName(name),
//         toast.success(`Welcome to Homes.com ${userName}`)
//       )
//       .catch(
...
//   return (
//     <div className="bg-gray-800 text-gray-800 w-full h-screen flex justify-center items-center lg:pt-12 px-4 ">
...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    createUserWithEmailAndPassword(auth, email, password, name)
      .then((result) => {
        ...
        setUserName(name), toast.success(`Welcome to Homes.com ${userName}`)
  ...
  return (
    <div className="bg-gray-800 text-gray-800 w-full  flex justify-center items-center lg:p-12   px-4 ">
      <div className="lg:w-1/3 md:w-1/2 w-full p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800 lg:mt-10 ">
        <h1 className="text-2xl font-bold text-center text-blue-700">
          Sign Up
        </h1>
        ...
        <div className="flex justify-center space-x-4">
          ...
          <button aria-label="Signup with GitHub" className="p-3 rounded-sm">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
